  ...
  const inner = (
    <>
      <span className="relative">
        {children}
        <span
          className={`absolute -bottom-1 left-0 h-[1px] ${underlineColor[variant]} w-0 group-hover:w-full transition-all duration-[400ms] origin-left`}
        />
        {/* Internal seam expand */}
        <span className="absolute -bottom-[3px] left-1/2 -translate-x-1/2 h-[1px] w-0 group-hover:w-1/2 bg-current opacity-10 transition-all duration-[500ms] delay-100" />
      </span>
      <ArrowRight
