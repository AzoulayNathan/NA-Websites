        ...
        >
          ...
          >
            ...
            >
              ...
              <Link to="/services" className="text-sm text-quartz/70 hover:text-quartz transition-colors">{t('nav.services', 'Services')}</Link>
              <Link to="/process" className="text-sm text-sky-blue hover:text-quartz transition-colors">{t('nav.process')}</Link>
              <Link to="/about" className="text-sm text-quartz/70 hover:text-quartz transition-colors">{t('nav.about', 'About')}</Link>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <a href="mailto:nathanazoulay.pro@gmail.com" className="text-sm text-quartz/70 hover:text-quartz transition-colors">nathanazoulay.pro@gmail.com</a>
              <a href="https://www.linkedin.com/in/nathan-azoulay-0719b4207" target="_blank" rel="noreferrer" className="text-sm text-quartz/45 hover:text-sky-blue transition-colors">LinkedIn ↗</a>
              <a href="https://github.com/AzoulayNathan" target="_blank" rel="noreferrer" className="text-sm text-quartz/45 hover:text-sky-blue transition-colors">GitHub ↗</a>
            </div>
          </motion.div>
        </motion.div>
